        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <div class="og">
                        <p class="type-label-md">Fork of <a href="https://tsl.pages.dev/#/" target="_blank">TSL</a> by Electro and Prometheus</p>
                    </div>
                    ...
                    <p>
                        - Raw footage (or a pointercrate record of the level) AND clicks will ALWAYS be required for levels in the top 150
                    </p>
                    <p>
                    ...
                    <p>
                        Note: You will be pinged in #user-updates with the reason why your record was denied. If you are still unsure of why it was denied, or if the record was wrongfully denied, please DM any list mods on Discord
                    </p>
                </div>
            </div>
        </main>
